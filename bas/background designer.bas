  ...
  IF TOUCH THEN
    ...
    IF X<>OLDX OR Y<>OLDY THEN
      ...
      ELSE
        ...
        IF EDMODE=3 THEN
          A=$B002+((Y+MAPY)*MAPW+(X+MAPX))*2+1
          ATT=PEEK(A) AND %01111111
          POKE A,ATT OR PRIO*128
          A=$9000+(Y*32+X)*2+1
          ATT=PEEK(A) AND %01111000
          POKE A,ATT OR PRIO*128 OR PRIO
        END IF
...
TEXT EDMODE*2,15,"*"
TEXT 9,14,"F"
IF FLIPMODE=1 THEN TEXT 9,15,"X "
IF FLIPMODE=2 THEN TEXT 9,15," Y"
IF FLIPMODE=3 THEN TEXT 9,15,"XY"
TEXT 11,14,"P"
NUMBER 11,15,PRIO,1
RETURN
