      ...
      ELSE
        ...
        IF EDMODE=1 THEN
          ...
          FOR I=0 TO H
            FOR J=0 TO W
              C=SELCHAR+I*16+J
              ATT=SELPAL+PRIO*128+FLIPMODE*32
        ...
        IF EDMODE=2 THEN
          ...
          ATT=PEEK(A)
          ATT=ATT AND %01111111
          ATT=ATT OR PRIO*128
          POKE A,ATT
          A=$9000+(Y*32+X)*2+1
          ATT=PEEK(A)
          ATT=ATT AND %01111000
          ATT=ATT OR PRIO*128 OR PRIO
          POKE A,ATT
        END IF
      END IF
...
IF EDMODE=2 THEN GOSUB DRAWPRIO
RETURN
...
FOR CY=0 TO 13
  FOR CX=0 TO 19
    ...
    IF ATT AND %10000000 THEN ATT=ATT OR 1
    POKE A,ATT
  NEXT CX
NEXT CY
RETURN
...
TEXT EDMODE*2,15,"*"
TEXT 7,14,"F"
IF FLIPMODE=1 THEN TEXT 7,15,"X "
IF FLIPMODE=2 THEN TEXT 7,15," Y"
IF FLIPMODE=3 THEN TEXT 7,15,"XY"
TEXT 9,14,"P"
IF PRIO=1 THEN TEXT 9,15,"+"
RETURN
...
CHECKTABBAR:
IF Y>=14 THEN
  IF X>=14 AND X<=15 THEN GOTO MAPEDITOR
  IF X>=16 AND X<=17 THEN GOTO CHARMENU
...
25 07 01 07 25 07 01 07 04 07 05 07 06 07 06 07
06 07 06 07 06 07 06 07 06 07 05 07 05 07 05 07
06 07 06 07 06 07 06 07 06 07 06 07 06 07 06 07
05 07 01 07 02 07 01 07 02 07 01 07 02 07 02 07
01 07 02 07 01 07 02 07 01 07 01 07 02 07 01 07
02 07 01 07 02 07 01 07 02 07 01 07 02 07 01 07
02 07 01 07 02 07 02 07 01 07 02 07 01 07 02 07
01 07 01 07 02 07 01 07 02 07 01 07 02 07 01 07
02 07
