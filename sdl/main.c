...
int main(int argc, const char * argv[])
{
    ...
    window = SDL_CreateWindow("LowRes NX v0.7 (2)", SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, SCREEN_WIDTH * defaultWindowScale, SCREEN_HEIGHT * defaultWindowScale, windowFlags);
